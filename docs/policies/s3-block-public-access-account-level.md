...
This rule is covered by the [s3-block-public-access-account-level](https://github.com/hashicorp/policy-library-CIS-Policy-Set-for-AWS-S3-Terraform/blob/main/policies/s3-block-public-access-account-level.sentinel) policy.
